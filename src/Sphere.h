...
public:
    // ctor/dtor
    Sphere(float radius=1.0f, int sectorCount=72, int stackCount=72, bool smooth=true);
    ~Sphere() {}

    int getVertexesCount() { return vertexes.size(); }
    Vertex* getVertexes()  { return vertexes.data(); }
